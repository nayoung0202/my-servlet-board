...
public class BoardMemoryDao implements BoardDao {
    ...
    private BoardMemoryDao() {
        BoardMemoryDB.add(new Board(1L, "첫 번째 글!!", "반갑습니다", "손흥민", LocalDateTime.now(), 10, 2, 1L));
        BoardMemoryDB.add(new Board(2L, "두 번째 글!!", "반갑습니다", "손흥민", LocalDateTime.now(), 10, 2, 1L));
        BoardMemoryDB.add(new Board(3L, "세 번째 글!!", "반갑습니다", "손흥민", LocalDateTime.now(), 10, 2, 1L));
        BoardMemoryDB.add(new Board(4L, "네 번째 글!!", "반갑습니다", "손흥민", LocalDateTime.now(), 10, 2, 1L));
        BoardMemoryDB.add(new Board(5L, "다섯 번째 글!!", "반갑습니다", "손흥민", LocalDateTime.now(), 10, 2, 1L));
        BoardMemoryDB.add(new Board(6L, "여섯 번째 글!!", "반갑습니다", "손흥민", LocalDateTime.now(), 10, 2, 1L));
        BoardMemoryDB.add(new Board(7L, "일곱 번째 글!!", "반갑습니다", "손흥민", LocalDateTime.now(), 10, 2, 1L));
        BoardMemoryDB.add(new Board(8L, "여덟 번째 글!!", "반갑습니다", "손흥민", LocalDateTime.now(), 10, 2, 1L));
        BoardMemoryDB.add(new Board(9L, "아홉 번째 글!!", "반갑습니다", "손흥민", LocalDateTime.now(), 10, 2, 1L));
        BoardMemoryDB.add(new Board(10L, "열 번째 글!!", "반갑습니다", "손흥민", LocalDateTime.now(), 10, 2, 1L));
    }
