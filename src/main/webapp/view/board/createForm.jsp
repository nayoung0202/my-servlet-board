...
<body>
<header>
  <a class="logo" href="/view/board/li"><img src="https://poiemaweb.com/img/logo.png"></a>
  <nav>
    <ul class="nav-items">
...
<%--            </div>--%>
          ...
          <div class="mb-3">
            ...
            <textarea name="contents" class="form-control" cols="30" rows="5" id="contents" placeholder="내용을 입력해주세요"></textarea>
          </div>
          <br>
          <div class="row">
            <div class="col-md-6 mb-3">
